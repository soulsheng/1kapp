...
public class insert_0005fsales$jsp extends HttpJspBase {

    // begin [file="/insert_sales.jsp";from=(7,0);to=(7,68)]
    // end
    // begin [file="/insert_sales.jsp";from=(10,3);to=(10,45)]
         String wareId,warename,wareunit,waredate;
    // end
    // begin [file="/insert_sales.jsp";from=(11,3);to=(11,15)]
         int amount;
    // end
    // begin [file="/insert_sales.jsp";from=(12,3);to=(12,16)]
         float price;
    // end

    static {
    }
    public insert_0005fsales$jsp( ) {
    }
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // HTML // begin [file="/insert_sales.jsp";from=(0,51);to=(7,0)]
                out.write("\r\n<html>\r\n<head>\r\n<title>\r\nInsert_stocking\r\n</title>\r\n</head>\r\n");
            ...
            // end
            // HTML // begin [file="/insert_sales.jsp";from=(7,68);to=(10,0)]
                out.write("\r\n<body bgcolor=\"#ffffff\">\r\n<h1>成功插入新记录</h1>\r\n");

            // end
            // HTML // begin [file="/insert_sales.jsp";from=(10,47);to=(11,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/insert_sales.jsp";from=(11,17);to=(12,0)]
                out.write("\r\n");

            // end
            // HTML // begin [file="/insert_sales.jsp";from=(12,18);to=(13,0)]
                out.write("\r\n");

            // end
            // begin [file="/insert_sales.jsp";from=(13,2);to=(21,18)]
                 wareId=request.getParameter("Wares_ID");
                  ...
                  sqlID.execUpdate("insert into sales_table values ('"+
                   wareId+"','"+warename+"',"+amount+","+price+",'"+wareunit+"','"+
                   waredate+"')");
            // end
            // HTML // begin [file="/insert_sales.jsp";from=(21,20);to=(26,0)]
