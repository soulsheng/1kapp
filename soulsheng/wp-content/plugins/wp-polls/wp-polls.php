...
function poll_scripts() {
	...
	wp_localize_script('wp-polls', 'pollsL10n', array(
		...
		'text_valid' => __('Please choose.', 'wp-polls'),
...
function create_poll_table() {
	...
	'<p style="text-align: center;"><input type="button" name="vote" value="   '.__('投票', 'wp-polls').'   " class="Buttons" onclick="poll_vote(%POLL_ID%);" /></p>'.
	'<p style="text-align: center;"><a href="#ViewPollResults" onclick="poll_result(%POLL_ID%); return false;" title="'.__('View Results Of This Poll', 'wp-polls').'">'.__('查看结果', 'wp-polls').'</a></p>'.
	'</div>');
	...
	'<p style="text-align: center;">'.__('总票数', 'wp-polls').': <strong>%POLL_TOTALVOTERS%</strong></p>'.
	'</div>');
	add_option('poll_template_resultfooter2', '</ul>'.
	'<p style="text-align: center;">'.__('总票数', 'wp-polls').': <strong>%POLL_TOTALVOTERS%</strong></p>'.
	'<p style="text-align: center;"><a href="#VotePoll" onclick="poll_booth(%POLL_ID%); return false;" title="'.__('Vote For This Poll', 'wp-polls').'">'.__('投票', 'wp-polls').'</a></p>'.
	'</div>');
