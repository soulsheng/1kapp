...
<script type="text/javascript" src="autoplay-player-compressed.js"></script>
...
?>
  ...
  <?php /*?>  <input name="playlistmod" type="radio" value="true" <?php echo $isvertical=="true" ? "checked='checked'" : "";?>>
  Right Playlist &nbsp;
  <input name="playlistmod" type="radio" value="false" <?php echo $isvertical=="false" ? "checked='checked'" : "";?>>
  Bottom Playlist<?php */?>
