...
*/
	...
	define('QA_MYSQL_HOSTNAME',  SAE_MYSQL_HOST_S.':'.SAE_MYSQL_PORT); // try '127.0.0.1' or 'localhost' if MySQL on same server
	define('QA_MYSQL_USERNAME', SAE_MYSQL_USER);
	define('QA_MYSQL_PASSWORD', SAE_MYSQL_PASS);
	define('QA_MYSQL_DATABASE',  SAE_MYSQL_DB);
