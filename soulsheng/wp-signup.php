...
function show_blog_form($blogname = '', $blog_title = '', $errors = '') {
	...
	if ( !is_user_logged_in() ) {
		...
		echo '<p>(<strong>' . sprintf( __('Your address will be %s.'), $site ) . '</strong>) ' . __( 'Must be at least 2 characters, letters and numbers only. It cannot be changed, so choose carefully!' ) . '</p>';
	}
...
function show_user_form($user_name = '', $user_email = '', $errors = '') {
	...
	_e( '(Must be at least 2 characters, letters and numbers only.)' );
	?>
